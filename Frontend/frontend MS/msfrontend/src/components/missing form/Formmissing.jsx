...
const Formmissing = () => {
  const [user, setUser] = useState({name:'',email:'',datemissing:'',identification:'',cnic:'',address:'',height:0,Gender:''})
      ...
      <form method="POST">
        <div className="user-details">
          ...
          <div className="input-box">
            ...
            <input type="text" placeholder="Enter person's cnic" name="cnic" value={user.cnic} onChange={handleinput} required/>
          </div>
          <div className="input-box">
          ...
          <div className="input-box">
            ...
            <input type="text" placeholder="Enter contact number" name="phonenumber" value={user.phonenumber} onChange={handleinput} required/>
          </div>
          {/* <div className="input-box">
...
<div className="textphoto">
  ...
  <img src={formimage} alt=""  width='600px'/>
</div>
