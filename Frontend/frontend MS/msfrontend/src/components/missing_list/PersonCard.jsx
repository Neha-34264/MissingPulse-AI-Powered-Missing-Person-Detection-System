...
const PersonCard = (props) => {
  ...
  if(responsestatus==200){
    alert(`person having cnic ${id} deleted successfully`)
  }

  const newcases= props.totalcases.filter((noteelement)=>{return noteelement.cnic!==id})
      ...
      <div class="flex flex-row rounded-lg border border-gray-200/80 bg-white p-6">
        ...
        <div class="flex flex-col px-6">
          ...
          <div class="flex h-8 flex-row">
            ...
            <a href="https://github.com/EgoistDeveloper/" target="_blank">
              ...
              <div className="mx-4 text-lg text-green-800 font-bold">
              {props.gender}
              </div>
            {/* <!-- User Verified --> */}
          ...
          <div class="my-2 flex flex-row space-x-2">
            ...
            <div class="flex flex-row">
              ...
              <div class="text-xs text-black hover:text-gray-400">{props.cnic}</div>
            </div>
            ...
            <div class="flex flex-row">
              ...
              <div class="text-xs text-black hover:text-gray-400">{props.address}</div>
            </div>
            ...
            <div class="flex flex-row">
              ...
              <div class="text-xs text-black hover:text-gray-400">{props.email}</div>
            </div>
          </div>
        ...
        <div class="w-100 flex flex-grow flex-col items-end justify-start">
          <div class="flex flex-row space-x-3">
            {/* <!-- Follow Button --> */}
            <button
              class="flex rounded-md bg-blue-500 py-2 px-4 text-white transition-all duration-150 ease-in-out hover:bg-blue-600" onClick={()=>{deletethis(props.cnic)}}>
