    ...
    <div className='contentlist'>
        {
            cases.map((element)=>{
                ...
                {/* console.log(src) */}
                return( <PersonCard name={element.name} cnic={element.cnic} email={element.email} date={element.Date_missing.substring(0,10)} height={element.height.$numberDecimal} identification={element.identification} gender={element.Gender} address={element.address} image={src} totalcases={cases} changecase={setCases}/>)
